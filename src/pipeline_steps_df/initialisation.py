...
def main(config_path):
    ...
    config.validate_paths() # todo: à modifier pour créer les dossiers si pas existants
...
if __name__ == "__main__":
    ...
    parser.add_argument('--configs', type=str, default="configs.yaml", help="Chemin vers le fichier de configuration YAML")
