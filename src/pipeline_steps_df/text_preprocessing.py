...
class StageTextPipeline:
    ...
    def init_stage(self):
        ...
        # todo: vérifier que le prétraitement du texte a été sauvegardé
        self.X_train = load_processed_npz("text_train", self.config.data_path)
        self.X_test = load_processed_npz("text_test", self.config.data_path)
